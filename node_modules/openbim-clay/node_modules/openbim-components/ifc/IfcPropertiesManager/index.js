...
export class IfcPropertiesManager extends Component {
    ...
    newPset(model, name, description) {
        ...
        const rel = new WEBIFC[schema].IfcRelDefinesByProperties(model.ifcMetadata.maxExpressID, relGlobalId, ownerHistoryHandle, null, null, [], new WEBIFC.Handle(pset.expressID));
