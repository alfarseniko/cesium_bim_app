...
import { Component, Disposable, SVGAnnotationStyle, UI, UIElement } from "../../base-types";
import { FloatingWindow, Toolbar } from "../../ui";
import { Components } from "../Components";
export interface SVGViewportConfig extends SVGAnnotationStyle {
}
export declare class SimpleSVGViewport extends Component<SVGElement> implements UI, Disposable {
    uiElement: UIElement<{
        toolbar: Toolbar;
